...
imagerecord := $.File_ImagePolyp.imageRecordPlus;
plusrecs    := SORT($.File_ImagePolyp.ImageDataPlus,recid);
mytraindata := PROJECT(plusrecs[1..40]+plusrecs[41..48],imagerecord):PERSIST('sarvesh::image::polyps');
mytestdata  := PROJECT(plusrecs[49..50]+plusrecs[51..53],imagerecord):PERSIST('sarvesh::image::polyptest');   
