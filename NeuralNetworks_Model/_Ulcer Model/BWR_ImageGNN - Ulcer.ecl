...
imagerecord := $.File_ImageUlcer.imageRecordPlus;
plusrecs    := SORT($.File_ImageUlcer.ImageDataPlus,recid);
mytraindata := PROJECT(plusrecs[1..40]+plusrecs[41..48],imagerecord):PERSIST('sarvesh::image::ulcer');
mytestdata  := PROJECT(plusrecs[49..50]+plusrecs[51..53],imagerecord):PERSIST('sarvesh::image::ulcertest');   
