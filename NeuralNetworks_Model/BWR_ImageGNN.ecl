...
mytraindata := PROJECT(plusrecs[1..3]+plusrecs[4..5],imagerecord):PERSIST('image::firstread::sarvesh');
mytestdata  := PROJECT(plusrecs[1..3]+plusrecs[4..5],imagerecord):PERSIST('image::firstreadtest::sarvesh');    
